...
open class C8o: C8oBase {
     ...
     */
    @objc public init(endpoint: String, c8oSettings: C8oSettings? = nil) throws {
        super.init()
        ...
        let regexV = C8o.RE_ENDPOINT.matches(in: endpoint, options: [], range: NSMakeRange(0, endpoint.count))
     ...
     */
    @objc open func call(_ requestable: String?, parameters: Dictionary<String, Any>? = nil, c8oResponseListener: C8oResponseListener, c8oExceptionListener: C8oExceptionListener? = nil) -> Void {
        ...
        do {
            ...
            let regexV = regex.matches(in: requestable!, options: [], range: NSMakeRange(0, requestable!.count))
    ...
    @objc open func call(_ parameters: Dictionary<String, Any>? = nil, c8oResponseListener: C8oResponseListener? = nil, c8oExceptionListener: C8oExceptionListener? = nil) throws {
        var parameters = parameters
        ...
        call(requestable,
             ...
             c8oResponseListener: C8oResponseJsonListener(onJsonResponse: {
                ...
                if (response!.isEqual(NSNull())) {
                    ...
                    promise.onResponse(JSON(response as Any), parameters: requestParameters)
                }
                
             }),
             c8oExceptionListener: C8oExceptionListener(onException: {
                (exep: C8oException, params: Dictionary<String, Any>?) -> () in
                
                promise.onFailure(exep, parameters: params)
             }))
        return promise
    }
    ...
    open func callJson(_ requestable: String, parameters: Any?...) -> C8oPromise<JSON> {
        ...
        return callJson(requestable, parametersDict: dictionnary)
    ...
    open func addCookie(_ name: String, value: String) -> Void {
        _ = httpInterface!.addCookie(name, value: value)
    }
