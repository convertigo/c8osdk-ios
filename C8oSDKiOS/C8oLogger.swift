 ...
 public class C8oLogger
{
    ...
    public func Fatal(message: String, exceptions: NSException?) ->Void
    {
        Log(C8oLogLevel.FATAL, message: message, exception: exceptions);
    }
    
    public func Error(message: String, exceptions: NSException?) -> Void
    {
        Log(C8oLogLevel.ERROR, message: message, exception: exceptions);
    }
    
    public func Warn(message: String, exceptions: NSException?) -> Void
    {
        Log(C8oLogLevel.WARN, message: message, exception: exceptions);
    }
    
    public func Info(message: String, exceptions: NSException?) -> Void
    {
        Log(C8oLogLevel.INFO, message: message, exception: exceptions);
    }
    
    public func Debug(message: String, exceptions: NSException?) -> Void
    {
        Log(C8oLogLevel.DEBUG, message: message, exception: exceptions);
    }
    
    public func Trace(message: String, exceptions: NSException?) -> Void
    {
